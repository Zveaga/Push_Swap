...
/*   Updated: 2023/04/12 17:13:18 by raanghel      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void			rotate_both(t_stack **head_a, t_stack **tail_a, t_stack **head_b, t_stack **tail_b);

void			reverse_rotate(t_stack **head, t_stack **tail);

void			reverse_rotate_both(t_stack **head_a, t_stack **tail_a, t_stack **head_b, t_stack **tail_b);
